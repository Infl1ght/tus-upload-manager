...
class UploadQueue {
    constructor(callbacks, createUploader, queueId) {
            ...
            try {
                ...
                return new Promise((resolve, reject) => {
                    const uploader = this.createUploader(task.file, {
                        endpoint: '/uploads/',
                        uploadUrl: (task === null || task === void 0 ? void 0 : task.tusdId) ? `/uploads/${task === null || task === void 0 ? void 0 : task.tusdId}` : undefined,
