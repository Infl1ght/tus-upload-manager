...
describe('Upload Manager', () => {
    ...
    beforeEach(() => {
        ...
        uploadManager = new _1.default(createUploader, callbacks, { uploadRetryDelays: [3000, 6000, 9000, 12000, 15000, 18000, 21000, 30000, 60000], maxUploadThreads: 3, onOfflineMessage: 'Offline', url: 'some_url' });
    });
    it('Smoke test', () => {
    ...
    it('Start 2 tasks, 1 with error', () => __awaiter(void 0, void 0, void 0, function* () {
        const flightId = 1;
        const tasks = getTasks(flightId, 2);
        uploadManager = new _1.default((file, options) => createWithErrorUploader(file, options), callbacks, { uploadRetryDelays: [3000, 6000, 9000, 12000, 15000, 18000, 21000, 30000, 60000], maxUploadThreads: 3, onOfflineMessage: 'Offline', url: 'some_url' });
        uploadManager.addUploadTasks(flightId, tasks);
        yield new Promise(res => setTimeout(res, TIME_TO_TASK * tasks.length + TIME_DELTA));
